...
- `GET /api/booking/sessions/{token}` — public read for the lead booking UI
- `POST /api/booking/sessions/{token}/confirm` — body `{ "slot_start": "<iso>" }`; confirms and notifies outbound
